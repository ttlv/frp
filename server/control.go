		...
		case rawMsg, ok := <-ctl.readCh:
			...
			case *msg.NewProxy:
				...
				if err != nil {
					...
					getResult, err := ttlv_utils.Get(fmt.Sprintf("%v/frp_fentch/%v", ctl.serverCfg.FrpAdapterServerAddress, fmt.Sprintf("node_maintenance_name-%v", ctl.loginMsg.UniqueID)), nil)
					if err != nil {
